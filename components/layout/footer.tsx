...
export const Footer = () => {
    return (
        <section className="bg-[#fff998] mt-10 p-6 sm:p-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-start">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-black py-3 stylefont flex items-center">
                    Company 
                    <div className="-mt-2 -ml-1 text-5xl lg:text-7xl">
                        <GoDash />
                    </div>
            ...
            <div className="text-start">
                ...
                <h3 className="font-semibold text-black py-1 flex items-center gap-2">
                    <FaLocationDot />
                    Kamaladi Kathmandu
                </h3>
                ...
                <h3 className="font-semibold py-1 text-black flex items-center gap-3">
                    <IoMail />
                    lahanalunchbox@gmail.com
                </h3>
                <div className="flex font-bold py-1 text-2xl text-black gap-4">
                    <FaFacebook />
                    <FaYoutube />
                    <FaLinkedin />
                    <FaInstagramSquare />
            ...
            <div className="text-start">
                ...
                <h3 className="font-semibold text-black py-1 text-xl">Sunday - Friday</h3>
                <h3 className="text-black py-1">09AM - 09PM</h3>
                <h3 className="font-semibold py-1 text-black text-xl">Saturday</h3>
                <h3 className="text-black py-1">10AM - 08PM</h3>
            </div>
        </section>
    );
};
