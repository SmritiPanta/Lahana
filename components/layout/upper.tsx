    ...
    return (
        <section className="flex flex-col items-center justify-center h-[650px] overflow-x-hidden relative">
            ...
            <div className="flex h-full w-full flex-col justify-center gap-6 px-6 md:px-10">
                <h1 className="text-white text-3xl md:text-6xl font-bold max-w-[90%] sm:max-w-[300px] md:max-w-[500px] font1">
                    Enjoy Our
                    Delicious Meal
                </h1>
                <p className="text-white max-w-[90%] sm:max-w-[300px] md:max-w-[500px]">
                    From savory to sweet, our dishes are crafted with care and passion, promising to delight your palate with every mouthful.
                    Join us and experience the joy of truly tasty food, where every dish is a celebration of flavor.
                </p>
