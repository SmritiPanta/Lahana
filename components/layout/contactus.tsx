...
export const Contactus = () => {
  return (
    <section id="contact-us" className="  container pt-10">
      <h1 className="text-4xl font-semibold text-[#EE2916] ml-16 px-10 font1">
        Contact Us
      </h1>
      <h1 className="text-2xl stylefont font-semibold flex pt-4 ml-10 text-black">
        Have a questions or need more information? We would love to hear from
        you!
      </h1>

      <div className="flex flex-col md:flex-row ">
        <div className="flex flex-col items-center md:items-start w-[30%] md:mt-0 md:w-[50%] px-4 md:px-10 pt-5">
          <div className="w-full flex flex-col gap-3">
            <div className="flex flex-col pt-3">
              <MdEmail className="ml-10 text-2xl text-[#EE2916]" />
              <h1 className="px-10 pt-1 font-bold text-xl">Email</h1>
              <h1 className="px-10 pt-1 font-semibold">
                Monday - Friday :9am-5pm
              </h1>
              <Link
                href="mailto:lahanalunchbox@gmail.com"
                className="px-10 pt-1 font-semibold underline"
              >
                lahanalunchbox@gmail.com
              </Link>
            </div>
        ...
        {/* <Image src={'/map.png'} objectFit="contain" alt={'table'} layout="fill" className="absolute bg-mint text-mint  "></Image> */}
        {/* </div> */}
        <div className=" w-9/10 md:w-1/2 px-4 md:px-10 pt-5 mb-5 ">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.241857245103!2d85.31672892425418!3d27.709817875384672!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb1906c7d8ba87%3A0xeb2649ae59dcda2e!2sKamaladi%2C%20Kathmandu%2044600!5e0!3m2!1sen!2snp!4v1720066090246!5m2!1sen!2snp"
            width="100%"
            height="430"
            allowFullScreen
            loading="lazy"
