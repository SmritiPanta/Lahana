...
//   const router = useRouter(); // Using next/navigation for navigation
...
//         const response = await fetch("https://newa-lahana.hyperce.io/shop-api", {
//           method: "POST",
//           headers: {
...
//       <h1 className="text-3xl font-bold text-gray-800 mb-4">Subscription Details</h1>

//       <div className="bg-white shadow-md rounded-lg p-6 mb-6">
//         <h2 className="text-2xl font-semibold text-gray-700 mb-2">Subscription Type: {subscriptionData?.type}</h2>
//         <p className="text-lg text-gray-600">Price: <span className="font-bold">${subscriptionData?.price}</span></p>
//         <p className="text-lg text-gray-600">Category: {subscriptionData?.category}</p>
//       </div>

//       <h2 className="text-2xl font-semibold text-gray-800 mb-2">Weekly Details:</h2>
...
//           <h3 className="text-xl font-semibold text-gray-800 mb-2">Details for {selectedDay.dayOfWeek}</h3>
//           <Image
//             src={'/nonveg.JPG'}
//             objectFit='contain'
...
//             width='300'
//             height='200'
//             className='bg-mint text-mint fill-current mb-4 ml-20 rounded-xl mt-2'
//           />
...
//             </ul>
//           ) : (
//             <p className="text-gray-600">No items available for this day.</p>
//           )}
//         </div>
//       )}
...
const SubscriptionDetails: React.FC<SubscriptionDetailsProps> = ({
  ...
  return (
     <div className=" "> 
    {/* <div container mx-auto p-6 max-w-2xl></div> */}
      ...
      {selectedDay && (
        <div className="bg-white shadow-md rounded-lg p-6 mt-6">
          ...
          {selectedDay.items.length > 0 ? (
            <ul className="list-disc pl-5">
              {selectedDay.items.map((item, index) => (
                <li key={index} className="container bg-[#fff998] rounded-2xl mt-3 mx-auto p-6 max-w-2xl text-black">
                  <strong className="font-semibold text-black text-2xl">{item.name}:</strong>
                  {item.description}
